 ...
 * @author Aldhi Ramdan
 */
public class Pegawai extends javax.swing.JFrame implements PegawaiMvpView<PegawaiModel> {

    PegawaiPresenter mPresenter;

    /**
     * Creates new form Ticket
     */
    public Pegawai() {
        mPresenter = new PegawaiPresenter();
    ...
    @Override
    public void onSucceed(BasePresenter.DataAccessType dataAccessType, PegawaiModel model) {
        if (model != null) {
    ...
    private void showDataTable() {
        ...
        ArrayList<PegawaiModel> list = mPresenter.getData();
        if (list != null) {
            for (PegawaiModel item : list) {
    ...
    private PegawaiModel getObjectModel() {
